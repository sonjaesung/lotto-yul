            ...
            <li className="sub_title">
              ...
              <table className="defaultTb">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="borderNoneLeft">㈜웅진씽크빅</td>
                    <td>
                      [웅진프라임학원] 시스템 개발 및 운영, 온라인 결제 서비스
                      이용, 학원비 수납
                    </td>
                    <td>
                      성명, 법정 생년월일, 휴대폰번호, 결제정보, CI
                      <br />
                      *웅진프라임학원 회원에 한함
                    </td>
                  </tr>
          ...
          <ol>
            <li className="sub_title">
              ...
              <table className="defaultTb">
                ...
                <tbody>
                  <tr>
                    <td className="borderNoneLeft">성명</td>
                    <td>강동진</td>
                    <td>전진</td>
                  </tr>
                  <tr>
